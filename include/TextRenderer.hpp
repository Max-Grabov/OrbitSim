...
const int lower_case_x_positions[] = {8, 19, 30, 41, 52, 63, 71, 82, 93, 97, 108, 117, 122, 133, 144, 155, 165, 176, 187, 198, 205, 216, 227, 238, 248, 259, 269};
const int upper_case_x_positions[] = {8, 19, 30, 41, 52, 63, 74, 84, 95, 102, 113, 124, 135, 145, 156, 167, 178, 189, 200, 210, 220, 232, 242, 253, 264, 275, 286};
const int number_x_positions[] = {9, 20, 30, 41, 52, 63, 73, 84, 95, 106, 116};

class TextRenderer {
public:
    // texture_ has to be a raw pointer, since it doesn't have a destructor to take care of destroying the texture after it falls out of scope
    // This means it can't be written utilizing a simple shared_ptr, since it won't call the required destroy texture method
