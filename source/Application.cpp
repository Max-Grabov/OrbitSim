...
void Application::init()
{
  ...
  text_renderer_.render(renderer_, "Simulation", SCREEN_WIDTH / 2 - 43 - 150, SCREEN_HEIGHT / 2 - 25);
...
void Application::handleKeyboardInput()
{
  ...
  case SDL_SCANCODE_TAB:
    SDL_SetRenderDrawColor(renderer_, 255, 255, 255, SDL_ALPHA_OPAQUE);
    SDL_RenderDrawLine(renderer_, Options[selected_screen_].x,
                                 Options[selected_screen_].y + 210,
                                 Options[selected_screen_].x + 200,
                               Options[selected_screen_].y + 210);
